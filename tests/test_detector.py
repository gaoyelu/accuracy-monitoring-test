...
def test_detector_topk_n_truncates_without_locking(detector):
    ...
    detector.detector([{1: -0.1, 2: -0.2, 3: -0.3, 4: -0.4, 5: -0.5}], [1], topk_n=5)
...
def test_detector_topk_n_none_uses_min_len(detector):
    ...
    res = detector.detector([{1: -0.1, 2: -0.2, 3: -0.3}, {1: -0.1, 2: -0.2, 3: -0.3}], [1, 2])
...
def test_detector_with_vocabulary_uses_precomputed(detector):
    ...
    res = detector.detector([{1: -0.1, 2: -2.0, 3: -3.0}, {1: -0.2, 2: -2.0, 3: -3.0}], [1, 2], topk_n=3)
